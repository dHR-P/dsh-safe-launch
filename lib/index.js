 ...
 * Windows: spawn argv becomes the CreateProcess command line; wrapping the
 * whole command in outer quotes makes cmd treat the quoted string as the
 * command name (`'"npm ..."' 不是内部或外部命令`), so pass it verbatim
 * and let cmd parse the inner quotes itself. */
